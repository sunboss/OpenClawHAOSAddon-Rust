...
mod tests {
    ...
    fn sample_page_config() -> PageConfig {
        PageConfig { addon_version: "2026.04.15.4".to_string(), access_mode: "lan_https".to_string(), gateway_url: String::new(), openclaw_version: "2026.4.14".to_string(), https_port: "18789".to_string(), gateway_token: "tok_test_12345678".to_string() }
    }
...
fn shell_window_button(label: &str) -> String {
    format!(r#"<button class="btn secondary" type="button" onclick="ocOpenShellWindow()">{label}</button>"#)
}
