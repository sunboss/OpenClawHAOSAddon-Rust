...
- Version:
  ...
  - Rust rewrite repo local manifest still shows `2026.04.07.1`; this documentation pass does not claim a Rust rewrite release.
- Commit:
  - Production latest: `5301ffc`
  - Documentation package commit: pending at time of this entry
- Push:
  - Production `sunboss/openclaw-ha-addon` pushed successfully.
  - Documentation package push pending.
- Result summary:
  - HAOS now shows `version=2026.05.20.2`, `version_latest=2026.05.20.2`, `update_available=false`.
